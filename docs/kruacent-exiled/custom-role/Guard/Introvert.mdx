---
title: Introverti
description: Un garde solitaire qui se déplace plus rapidement lorsqu'il n'y a personne autour de lui.
date: 2026-08-24
image: /img/doc/teams/guard.png
keywords: [garde, guard, introvert, introverti, vitesse, speed]
...
> **FR :** *"Tu n'aimes pas trop les humains"*

> **EN :** *"your better by yourself"*

L'**Introverti** est un garde asociales. Loin d'être un désavantage tactique, son besoin de solitude se traduit par une agilité accrue lorsqu'il est seul. Dès qu'il s'isole, il gagne drastiquement en mobilité.
...
Il possède un équipement avec plus de grenade flash qu'un garde classique.

| Équipement | Détails et Quantité |
| :--- | :--- |
| <ItemLink name="FSP-9" /> | 1x |
| **Munitions 5.56x45mm** | 60x |
| <ItemLink name="Armure légère" wikiId="Light_Armor" /> | 1x |
| <ItemLink name="Carte d'accès de Garde" wikiId="Keycard" /> | 1x |
| <ItemLink name="Medkit" wikiId="First_Aid_Kit" /> | 1x |
| <ItemLink name="Grenade Flash" wikiId="Flashbang_Grenade" /> | **2x** |

*(Il ne possède pas de radio, du fait qu'il déteste les interactions sociales).*

---

<PatchNoteBanner name="Introverti" tag="introverti" />